export const CLI_CHILD_MODE_ENV_VAR = 'MIKO_CLI_MODE';
...
export const CLI_CHILD_COMMAND_ENV_VAR = 'MIKO_CLI_CHILD_COMMAND';
export const CLI_CHILD_ARGS_ENV_VAR = 'MIKO_CLI_CHILD_ARGS';
