...
export function InterruptedMessage({ label = 'Interrupted', className }: InterruptedMessageProps) {
	return (
		<div className={cn('flex items-center justify-end my-3', className)}>
			<div className="inline-flex h-9 items-center gap-1.5 whitespace-nowrap rounded-lg border border-hairline bg-surface-2 pl-2.5 pr-3.5 text-body-sm text-ink-subtle">
